...
\newcommand{\projectTitle}{Learning Resources for Understanding and Using the Finite Element Method}
\newcommand{\fullname}{Kyle Antony Morris}
\newcommand{\degreeTitle}{Computer Science with Mathematics}
